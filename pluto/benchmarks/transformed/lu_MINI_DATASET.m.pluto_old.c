...
#pragma omp parallel for private(lbv,ubv,t3,t4,t5,t6)
    for (t2=lbp;t2<=ubp;t2++) {
      for (t3=0;t3<=min(min(floord(_PB_N-2,32),t2),t1-t2);t3++) {
        if (t2 == t3) {
          for (t4=max(32*t1-32*t2,32*t2+32);t4<=min(_PB_N-1,32*t1-32*t2+31);t4++) {
        ...
        if ((t1 == 2*t2) && (t1 == 2*t3)) {
          ...
          for (t6=16*t1+1;t6<=min(_PB_N-1,16*t1+31);t6++) {
            if (t1%2 == 0) {
              A[(16*t1+1)][t6] -= A[(16*t1+1)][16*t1] * A[16*t1][t6];;
            }
          }
        }
        ...
        if ((t1 == 2*t2) && (t1 == 2*t3)) {
          for (t4=16*t1+2;t4<=min(_PB_N-1,16*t1+31);t4++) {
            for (t5=16*t1;t5<=t4-2;t5++) {
              ...
              for (t6=t4;t6<=min(_PB_N-1,16*t1+31);t6++) {
                if (t1%2 == 0) {
                  A[t4][t6] -= A[t4][t5] * A[t5][t6];;
                }
              }
        ...
        if ((t1 == 2*t2) && (t1 >= 2*t3+2)) {
          for (t4=16*t1+1;t4<=min(_PB_N-1,16*t1+31);t4++) {
            for (t5=32*t3;t5<=32*t3+31;t5++) {
              for (t6=16*t1;t6<=t4-1;t6++) {
                if (t1%2 == 0) {
                  A[t4][t6] -= A[t4][t5] * A[t5][t6];;
                }
              }
