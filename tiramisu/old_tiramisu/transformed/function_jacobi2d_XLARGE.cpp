...
int main(int argc, char **argv)
{
    ...
    var i00("i00", 0, 2800 - 2), i01("i01", 0, 1000);
    ...
    buffer buf02("buf02", {2800, 1000}, p_int32, a_output);
    buffer buf00("buf00", {2800, 1000}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf02, &buf00}, "function_jacobi2d_XLARGE.o");
