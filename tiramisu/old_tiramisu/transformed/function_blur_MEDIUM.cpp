...
int main(int argc, char **argv)
{
    ...
    // iterators
    var i00("i00", 0, 5), i01("i01", 0, 98 - 2), i02("i02", 0, 258 - 2);
    ...
    // buffers
    buffer buf01("buf01", {5, 98, 258}, p_int32, a_output);
    buffer buf00("buf00", {5, 98, 258}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf01, &buf00}, "./function_blur_MEDIUM.o");
