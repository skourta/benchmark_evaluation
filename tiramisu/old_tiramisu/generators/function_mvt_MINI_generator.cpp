...
int main(int argc, char **argv)
{
    ...
    // buffers
    buffer buf03("buf03", {40}, p_int32, a_output);
    buffer buf04("buf04", {40}, p_int32, a_output);
    buffer buf00("buf00", {40, 40}, p_int32, a_input);
    buffer buf01("buf01", {40}, p_int32, a_input);
    buffer buf02("buf02", {40}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf03, &buf04, &buf00, &buf01, &buf02}, "./function_mvt_MINI.o");
