...
int main(int argc, char **argv)
{
    ...
    // Layer I
    // -------------------------------------------------------
    var i00("i00", 0, 16) , i01("i01", 0, 32) , i02("i02", 0, 48) ;
    //inputs
    ...
    // -------------------------------------------------------
    //Input Buffers
    buffer buf02("buf02", {16, 32}, p_int32, a_output);
    buffer buf00("buf00", {16, 48}, p_int32, a_input);
    buffer buf01("buf01", {48, 32}, p_int32, a_input);
    ...
    // Code Generation
    // -------------------------------------------------------
    tiramisu::codegen({&buf02, &buf00, &buf01}, "function_matmul_MINI.o");
