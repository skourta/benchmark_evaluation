...
int main(int argc, char **argv)
{
    ...
    // iterators
    var i00("i00", 0, 4000) , i01("i01", 0, 4000);
    ...
    // buffers
    buffer buf03("buf03", {4000}, p_int32, a_output);
    buffer buf04("buf04", {4000}, p_int32, a_output);
    buffer buf00("buf00", {4000, 4000}, p_int32, a_input);
    buffer buf01("buf01", {4000}, p_int32, a_input);
    buffer buf02("buf02", {4000}, p_int32, a_input);
    ...
    tiramisu::codegen({&buf03, &buf04, &buf00, &buf01, &buf02}, "./function_mvt_XLARGE.o");
