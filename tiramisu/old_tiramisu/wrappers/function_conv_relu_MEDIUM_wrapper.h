...
extern "C" {
#endif
int function_conv_relu_MEDIUM(halide_buffer_t *buf01, halide_buffer_t *buf00, halide_buffer_t *buf02, halide_buffer_t *buf03, halide_buffer_t *buf04);
#ifdef __cplusplus
}  // extern "C"
#endif
...
void declare_memory_usage(){
    setenv("MEM_SIZE", std::to_string((double)64*10*96*160*3*4*10*99*169*2*8/1024/1024).c_str(), true); // This value was set by the Code Generator
}
